...
| P1 | 연결 파일럿 완료·본선 평가 자산 대기 | 사진으로 검색 | 합성 비개인 16장 파일럿에서 Voyage 512d는 한국어·영어 text→image와 image→image, Nemotron Embed 2048d는 한국어·영어 text→image Top-1·Recall@5 만점을 기록했다. 쉬운 smoke 세트라 우열 근거는 아니며 Nemotron image query는 unsupported다. Nemotron Rerank의 한국어 image passage 1위 정합, Nemotron Omni·Gemma 4 31B의 이미지 판독 성공도 확인했다. Voyage 3 RPM 제한, Gemma 4 26B hosted 404, Llama 90B 60초 timeout을 기록했다. 비개인 600~1,000장·한국어 160질의·이미지 80질의와 사람 관련도 판정으로 본선 평가한 뒤 운영 공급자·어댑터·개인정보 고지를 승인한다. |
