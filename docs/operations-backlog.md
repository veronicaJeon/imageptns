...
| P1 | 빠른 후보 압축 완료·본선 평가 자산 대기 | 사진으로 검색·이미지 캡션 | 대화형 검색 1.5초, 비동기 캡션 5초 예산을 확정했다. 검색 후보는 Voyage 512d와 Nemotron Embed 2048d로 압축하고 image→image는 Voyage만 지원한다. 6.65초 Nemotron Rerank, 20.58초 Gemma 4 31B, hosted 404인 Gemma 4 26B, 60초 timeout Llama 90B는 제외해 runner가 다시 호출하지 않는다. 3.39초 Nemotron Omni만 비동기 캡션 후보로 유지한다. 신규 카탈로그 임베딩은 업로드 때가 아니라 관리자 승인 성공 뒤 `pending` 작업만 등록하고 별도 worker가 생성한다. 비개인 600~1,000장·한국어 160질의·이미지 80질의와 캡션 정확도·p95 본선 후 운영 공급자·어댑터·개인정보 고지를 승인한다. |
