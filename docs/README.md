...
5. [주간 제품·코드 유지보수 루틴](./maintenance-routine.md) — 일일 운영 근거를 코드·DB 검사와 대조해 후보·승인·수정·배포 결과를 누적하는 절차
...
| 사진으로 검색 | [사진으로 검색 1단계 설계](./superpowers/specs/2026-08-11-photo-search-design.md), [의미 기반 검색 2단계 설계](./superpowers/specs/2026-08-13-semantic-image-search-design.md), [다중 모델 품질시험 설계](./superpowers/specs/2026-08-14-semantic-model-evaluation.md), [2026-08-18 연결·파일럿 근거](./semantic-model-evaluation-evidence-2026-08-18.md) |
...
| 정기 유지보수 | [주간 제품·코드 유지보수 루틴](./maintenance-routine.md) |
