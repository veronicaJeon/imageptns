...
| 사진으로 검색 | [사진으로 검색 1단계 설계](./superpowers/specs/2026-08-11-photo-search-design.md), [의미 기반 검색 2단계 설계](./superpowers/specs/2026-08-13-semantic-image-search-design.md), [다중 모델 품질시험 설계](./superpowers/specs/2026-08-14-semantic-model-evaluation.md) |
