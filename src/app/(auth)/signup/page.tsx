...
export default function SignupPage() {
  ...
  return (
    <>
      ...
      {/* ── Right panel ── */}
      <div className="w-full min-w-0 lg:w-1/2 flex flex-col justify-center px-8 md:px-16 xl:px-24 py-16 bg-surface overflow-y-auto">
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          {!emailSent && (
            <>
              ...
              {/* Google OAuth */}
              <a
                href={`/api/auth/google?next=${encodeURIComponent("/dashboard")}&role=${role}&organization=${encodeURIComponent(organization.trim())}`}
                onClick={() => {
                  setLoading(true);
                  setError(null);
                }}
