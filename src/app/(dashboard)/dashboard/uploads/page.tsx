...
const UPLOADS_PAGE_COPY = {
  ko: {
    locale: "ko-KR",
    filterTabs: { all: "전체", pending: "검토 대기", approved: "승인됨", rejected: "반려됨", removed: "공개 중지·삭제" },
    empty: {
      all: "업로드한 이미지가 없습니다. 작품을 공유해보세요.",
      pending: "검토 대기 중인 이미지가 없습니다.",
      approved: "승인된 이미지가 없습니다. 더 업로드해보세요.",
      rejected: "반려된 이미지가 없습니다.",
    ...
    deleteImmediateAccepted: "검색과 신규 사용권 주문에서 즉시 제외했습니다.",
    deleteDialogTitle: "이미지를 삭제하시겠습니까?",
    arweaveDeletionNotice: "이 이미지는 Arweave 원본 증명이 발급되어 증명 기록이 영구 저장되어 있습니다. 해당 기록 자체는 삭제할 수 없으며, 공개 중지·구매자 기록 보존·원본 증명 연결 검토를 관리자가 처리해야 하므로 삭제 수수료가 발생할 수 있습니다. 비용은 Arweave 원본 증명 이미지에만 적용됩니다.",
    immediateDeletionNotice: "이 이미지에는 Arweave 원본 증명이 없습니다. 확인하면 검색과 신규 사용권 주문에서 즉시 제외되고, 장바구니에서는 사라지며, 기존 주문 내역에서는 비활성 상태로 표시됩니다. 원본 파일과 데이터베이스 기록은 공개 중지·삭제 탭에서 직접 완전삭제할 수 있습니다.",
    ...
    finalDeleteConfirm: "이 이미지를 완전삭제할까요? 처리 후에는 복구할 수 없습니다.",
    ...
    attributionPlaceholder: "사진작가명 또는 스튜디오명",
