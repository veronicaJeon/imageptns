...
const CHECKOUT_PAGE_COPY = {
  ko: {
    ...
    errors: {
      ...
      freeCheckout: "무료 사용권을 확정하지 못했습니다.",
      passProcess: "결제 우회 처리 실패",
      passCheckout: "결제 우회를 완료하지 못했습니다.",
      bankTransferCreate: "계좌이체 요청을 생성하지 못했습니다.",
      bankTransferCheckout: "계좌이체 요청을 완료하지 못했습니다.",
      ...
      purchaseFailed: "사용권 구매 트랜잭션이 실패했습니다. 지갑에서 상태를 확인한 뒤 다시 시도해주세요.",
    ...
    steps: [
      ...
      { icon: "payments", title: "결제 진행", body: "카드 또는 Base USDC로 사용권 결제를 완료합니다." },
    ...
    freeSteps: [
      ...
      { icon: "redeem", title: "무료 사용권 확정", body: "결제수단 입력 없이 라이선스를 확정합니다." },
      { icon: "download", title: "원본 다운로드", body: "확정 즉시 다운로드 권한이 열립니다." },
    ],
    freeOrderTitle: "무료 라이선스 주문",
    subscriptionFreeOrderTitle: "구독 무료다운 주문",
    freeOrderBody: "결제 수단 입력 없이 무료 사용권이 확정되고 원본 다운로드 권한이 즉시 생성됩니다.",
    ...
    bankTransferDescription: "입금 확인 후 관리자가 주문을 확정합니다.",
    bankTransferBody: "계좌 입금 요청을 남기면 운영팀이 입금 확인 후 다운로드 권한을 열어드립니다.",
    bankTransferModalTitle: "계좌이체 요청이 접수되었습니다",
    ...
    baseBody: "지갑 연결 후 Base 네트워크에서 USDC 승인과 사용권 구매 트랜잭션을 순서대로 진행합니다.",
    baseQuote: "최종 USDC 금액은 주문 생성 시점에 15분 유효한 견적으로 고정됩니다.",
    approveBody: "USDC 사용 권한을 승인합니다.",
    purchaseBody: "Base에서 사용권 구매 트랜잭션을 전송합니다.",
    ...
    recoveryBody: "사용권 구매 tx는 감지됐지만 서버 확인이 끝나지 않았습니다.",
    retryConfirm: "결제 확인 다시 시도",
    viewOrders: "주문 내역 보기",
    confirmFree: "무료 사용권 확정",
    passTitle: "결제 우회 (테스트 전용)",
    passBody: "Toss 유료결제 연동 전 임시 기능입니다. 실제 결제 없이 주문을 완료하고 다운로드/정산 흐름을 점검합니다.",
    passButton: "결제 없이 주문 완료",
    downloadAccess: "결제가 승인되면 사용권이 확정된 이미지의 원본 다운로드 권한이 자동으로 생성됩니다. 완료 화면 또는 대시보드의 주문 내역에서 다시 다운로드할 수 있습니다.",
    subscriptionApplied: "구독 무료다운 적용",
    subscriptionActive: "구독 활성",
    remaining: "잔여",
    countSuffix: "개",
    subscriptionBody: (covered: string, days: string) => `이번 주문에서 ${covered}개가 무료다운으로 적용됩니다. 다운로드 권한은 주문 확정일부터 ${days}일간 유지됩니다.`,
