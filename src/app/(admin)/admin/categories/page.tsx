  ...
  return (
    <div className="p-6 md:p-10">
      <div className="mb-8 flex flex-col gap-2">
        <p className="text-xs font-bold uppercase tracking-widest text-primary">Image Taxonomy</p>
      ...
      <section className="overflow-hidden rounded-lg bg-surface-container-lowest shadow-ghost">
        <div className="grid grid-cols-[120px_1fr_1fr_100px_90px_92px] gap-3 border-b border-outline-variant/30 px-4 py-3 text-[11px] font-bold uppercase tracking-widest text-outline">
          <span>Code</span>
          <span>한글</span>
          <span>English</span>
          <span>순서</span>
        ...
        {loading ? (
          ...
          <div key={category.code} className="grid grid-cols-[120px_1fr_1fr_100px_90px_92px] gap-3 border-b border-outline-variant/20 px-4 py-3 last:border-b-0">
            <div className="flex items-center font-mono text-xs text-on-surface">{category.code}</div>
            <input
              value={category.ko}
              onChange={(event) => updateCategory(category.code, { ko: event.target.value })}
              className="h-10 rounded bg-surface-container-low px-3 text-sm outline-none ring-1 ring-outline-variant focus:ring-2 focus:ring-primary"
            />
            <input
              value={category.en}
            ...
            <button
              ...
              className={`inline-flex h-10 items-center justify-center rounded-full border px-3 text-xs font-bold ${category.active ? "border-primary bg-primary/10 text-primary" : "border-outline-variant text-outline"}`}
            >
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center rounded bg-on-surface px-3 text-xs font-bold text-surface disabled:opacity-50"
            >
              저장
            </button>
          </div>
