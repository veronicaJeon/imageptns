...
const COPY = {
  ko: {
    ...
    paidExample: "뉴스 기사 보도, 출판물·잡지·교재, 상업용 광고, 브랜드 굿즈 제작 등 유료 사용권 판매 수수료 정산 대상이 됩니다.",
    ...
    attributionYesBody: "사진작가명과 Image Partners 출처가 함께 표시됩니다.",
    attributionNo: "아니요, 별도 사진작가 표시는 없어도 돼요",
    attributionNoBody: "CC0가 적용됩니다. 단, 플랫폼 정책상 Image Partners 출처는 표시해야 합니다.",
    attributionExample: "블로그 포스팅, 개인 SNS, 비영리 리포트 등에 사진작가명과 출처 링크가 함께 표시됩니다.",
