...
const COPY = {
  ko: {
    ...
    paidExample: "뉴스 기사 보도, 상업용 광고, 브랜드 굿즈 제작 등 유료 판매 수수료 정산 대상이 됩니다.",
    ...
    commercialBody: "광고, 유료 콘텐츠, 기업 홍보물 등에 사용할 수 있습니다.",
  ...
  en: {
    ...
    paidExample: "Eligible uses include paid news coverage, advertising, and branded merchandise, with sales revenue settled to you.",
    ...
    commercialBody: "Allows advertising, paid content, and corporate promotional materials.",
