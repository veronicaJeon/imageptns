...
export const en: Translations = {
  ...
  support: {
    ...
    faqs: [
      ...
      { question: "What file formats do you accept?", answer: "The current upload screen accepts JPEG files up to 100 MB each. Rights information, title, description, tags, and capture details are required." },
