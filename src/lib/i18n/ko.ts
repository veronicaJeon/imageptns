...
export const ko: Translations = {
  ...
  support: {
    ...
    faqs: [
      ...
      { question: "무료로 사용할 수 있는 이미지가 있나요?", answer: "이미지 상세에 전체 무료, 교육용 무료 또는 Creative Commons 조건이 표시된 경우 해당 범위에서 사용할 수 있습니다. 무료 표시는 저작권 포기나 무제한 사용을 뜻하지 않습니다." },
    ],
  ...
  dashboard: {
    ...
    role: { buyer: "구매자", photographer: "사진작가" },
    overview: {
      greeting: "반갑습니다",
      statFavorites: "즐겨찾기", statOrders: "주문", statCart: "장바구니",
      statUploads: "업로드", statEarnings: "수익", statPending: "검토 대기",
      recentTitle: "최근 활동",
    ...
    uploads: { title: "내 업로드", uploadBtn: "새 업로드", empty: "업로드한 이미지가 없습니다. 이미지를 공유해보세요.", cols: { image: "이미지", status: "상태", views: "조회", sales: "판매", uploaded: "업로드일" }, statuses: { approved: "승인됨", pending: "검토 대기", rejected: "반려됨" } },
  ...
  cart: {
    ...
    checkoutBtn: "사용권 주문하기", continueBtn: "이미지 더 보기",
